...
MODEL_PREDICTION_MAP = {
    ModelType.Ridge_regression: make_live_prediction,
}
...
class PredictionPersistence:
    ...
    def make_save_predictions(self, *, db_model: ModelType, input_data: t.List) -> PredictionResult:
        ...
        if db_model == ModelType.Ridge_regression:
        ...
        try:
            ...
            # Ridge model `make_prediction` does not include errors
            pass
    ...
    def save_predictions(self, *, inputs: t.List, prediction_result: PredictionResult, db_model: ModelType,) -> None:
        ...
        prediction_data = Ridge_regression(
